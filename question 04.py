# -*- coding: utf-8 -*-
"""
Created on Fri Oct  6 16:09:05 2023

@author: LAB
"""
'''
4. Represent 2D matrix of dimensions M x N, by taking M, N and matrix elements as input from the
...
n1 = int(input('Enter the number of columnfor the first Matrix :'))
